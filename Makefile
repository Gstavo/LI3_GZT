...
compras: compras.c avl.h catalogo_produtos.h catalogo_clientes.h heap.h
...
main : main.c leitura.h compras.h catalogo_produtos.h catalogo_clientes.h compras.h hashtable.h heap.h contabilidade.h
	gcc $(CFLAGS) -c main.c 

gesthip: $(OBJS)
	gcc $(OBJS) -o gesthip

all: avl.c leitura.c catalogo_clientes.c catalogo_produtos.c contabilidade.c compras.c hashtable.c heap.c main.c
	make avl
	make hashtable
	make heap
