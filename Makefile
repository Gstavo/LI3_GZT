...
avl: avl.c compras.c 
	gcc $(CFLAGS) -c avl.c compras.c 

catalogo_clientes: catalogo_clientes.c avl.c compras.c
	gcc $(CFLAGS) -c catalogo_clientes.c avl.c compras.c

catalogo_produtos: catalogo_produtos.c avl.c compras.c
	gcc $(CFLAGS) -c catalogo_produtos.c avl.c compras.c

compras: compras.c catalogo_produtos.c catalogo_clientes.c avl.c
	gcc $(CFLAGS) -c compras.c catalogo_produtos.c catalogo_clientes.c avl.c


contabilidade: avl.c compras.c catalogo_produtos.c catalogo_clientes.c
	gcc $(CFLAGS) -c avl.c compras.c catalogo_produtos.c catalogo_clientes.c
